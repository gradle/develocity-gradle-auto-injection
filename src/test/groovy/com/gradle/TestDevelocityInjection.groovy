    ...
    class TestConfig {
        ...
        def getEnvVars() {
            Map<String, String> envVars = [
                DEVELOCITY_INJECTION_INIT_SCRIPT_NAME     : "develocity-auto-injection.init.gradle",
        ...
        def getJvmArgs() {
            List<String> jvmArgs = [
                "-Ddevelocity.injection.init-script-name=develocity-auto-injection.init.gradle",
